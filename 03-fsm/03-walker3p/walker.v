...
module walker(i_clk, o_led);
    ...
    initial {o_led, stb, counter, led_state, next_led_state} = 0;
    ...
    begin
        case (led_state)
            led_state_0:    next_led_state = led_state_1;
            led_state_1:    next_led_state = led_state_2;
            led_state_2:    next_led_state = led_state_3;
            led_state_3:    next_led_state = led_state_4;
            led_state_4:    next_led_state = led_state_5;
            led_state_5:    next_led_state = led_state_0;
            default:        next_led_state = led_state_0;
        endcase
    end
